...
dota_options = ['да', 'я не хочу играть в доту 2 сегодня', 'Буду только впятером', '10-20 мин', '30-40 мин', '50-60 мин', 'Друзья! Я пока что не могу, я подключусь попозже', 'я б лучше в каэс два']
