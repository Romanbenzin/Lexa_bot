...
from bot.data_base.data_base_actions import get_all_user_names_without_yana
from bot.team_speak.team_speak_server import status_server
from bot.deepseek.requests_to_deepseek import short_api_request
from telebot import types
from bot.telegram_bot.bot_database_core.bot_database_core import DbHandler
from bot.telegram_bot.helpers import find_random_video
from bot.telegram_bot.static_data.urls import izhevsk_url
from bot.telegram_bot.static_data.vote import bot_command_help, dota_question, dota_options, cs_options, cs_question, \
